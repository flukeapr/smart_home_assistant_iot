...
#define WIFI_SSID "Real7"
#define WIFI_PASSWORD "0611161502"
// MP.A4 600058960
// LABA051 11111111
// linux-ap 987654321
#define FIREBASE_HOST "smart-home-assistant-73a6e-default-rtdb.asia-southeast1.firebasedatabase.app"
#define FIREBASE_AUTH "AIzaSyDPUw_V-1a9bIk-2y3q0PKhQQBYWKaqeW8"
...
void loop() {
  ...
  if (fanOn) {
    if (now - lastUpdate >= 1000) {  // ทุก 1 วินาที
      lastUpdate = now;
  ...
  if (Firebase.ready() && millis() - lastFirebase > interval) {
    ...
    if (savingMode) {
      ...
      if (fan != -1) digitalWrite(relayPin, fan ? LOW : HIGH);
